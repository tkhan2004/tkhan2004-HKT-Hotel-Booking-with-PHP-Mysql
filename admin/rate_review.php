  ...
  if(isset($_GET['seen']))
  {
    ...
    if($frm_data['seen']=='all'){
      ...
      if(update($q,$values,'i')){
        alert('Thành công','Đánh dấu đã đọc!');
      }
      else{
  ...
  if(isset($_GET['del']))
  {
    ...
    if($frm_data['del']=='all'){
      ...
      if(mysqli_query($con,$q)){
        alert('Thành công','Tất cả dữ liệu đã được xóa!');
      }
      else{
        alert('Lỗi','Cập nhật thất bại!');
      }
      ...
      if(delete($q,$values,'i')){
        alert('Thành công','Dữ liệu đã được xóa!');
      }
      else{
        alert('Lỗi','Cập nhật thất bại!');
      }
  ...
  <div class="container-fluid" id="main-content">
    <div class="row">
      <div class="col-lg-10 ms-auto p-4 overflow-hidden">
        <h3 class="mb-4">REVIEWS VÀ ĐÁNH GIÁ</h3>
          ...
          <div class="card-body">
            ...
            <div class="text-end mb-4">
              <a href="?seen=all" class="btn btn-dark rounded-pill shadow-none btn-sm">
                <i class="bi bi-check-all"></i> Đánh dấu là đã đọc
              </a>
              ...
              <table class="table table-hover border">
                <thead>
                  <tr class="bg-dark text-light">
                    ...
                    <th scope="col" width="30%">Reviews</th>
                ...
                <tbody>
                  <?php 
                    ...
                    while($row = mysqli_fetch_assoc($data))
                    {
                      ...
                      $seen='';
                      if($row['seen']!=1){
                        $seen = "<a href='?seen=$row[sr_no]' class='btn btn-sm rounded-pill btn-primary mb-2'>Đánh dấu đã đọc</a> <br>";
                      }
