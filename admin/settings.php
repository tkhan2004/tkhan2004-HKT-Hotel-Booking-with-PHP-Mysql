      ...
      <div class="col-lg-10 ms-auto p-4 overflow-hidden">
        ...
        <div class="card border-0 shadow-sm mb-4">
          <div class="card-body">
            ...
            <h6 class="card-subtitle mb-1 fw-bold">Tên miền</h6>
            <p class="card-text" id="site_title"></p>
            <h6 class="card-subtitle mb-1 fw-bold">Thêm thông tin khách sạn</h6>
            ...
            <form id="general_s_form">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Cài đặt tổng thể</h5>
                </div>
                <div class="modal-body">
                  <div class="mb-3">
                    <label class="form-label fw-bold">Tên miền</label>
                    <input type="text" name="site_title" id="site_title_inp" class="form-control shadow-none" required>
                  </div>
                  <div class="mb-3">
                    <label class="form-label fw-bold">Thông tin về khách sạn</label>
        ...
        <div class="card border-0 shadow-sm mb-4">
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-3">
              <h5 class="card-title m-0">Đóng cửa khách sạn</h5>
            ...
            <p class="card-text">
              Sẽ không có khách hàng nào được đặt phòng khi, Khách sạn đang đóng cửa.
            </p>
          </div>
        </div>
        ...
        <div class="card border-0 shadow-sm mb-4">
          <div class="card-body">
            <div class="d-flex align-items-center justify-content-between mb-3">
              <h5 class="card-title m-0">Cài đặt thông tin liên hệ</h5>
            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="mb-4">
                  <h6 class="card-subtitle mb-1 fw-bold">Trang mạng xã hội</h6>
                  <p class="card-text mb-1">
        ...
        <div class="modal fade" id="contacts-s" data-bs-backdrop="static" data-bs-keyboard="true" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          <div class="modal-dialog modal-lg">
            <form id="contacts_s_form">
              <div class="modal-content">
                <div class="modal-header">
                  <h5 class="modal-title">Cài đặt thông tin liên hệ</h5>
                </div>
                <div class="modal-body">
