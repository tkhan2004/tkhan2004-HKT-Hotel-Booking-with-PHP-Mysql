  ...
  if(isset($_GET['fetch_rooms']))
  {
    ...
    if($chk_avail['checkin']!='' && $chk_avail['checkout']!='')
    {
      ...
      if($checkin_date == $checkout_date){
        echo"<h3 class='text-center text-danger'>Nhập ngày bị lỗi!</h3>";
        exit;
      }
      else if($checkout_date < $checkin_date){
        echo"<h3 class='text-center text-danger'>Lỗi ngày!</h3>";
        exit;
      }
      else if($checkin_date < $today_date){
        echo"<h3 class='text-center text-danger'>Lỗi thời gian!</h3>";
        exit;
      }
    }
        ...
        <div class='card mb-4 border-0 shadow'>
          <div class='row g-0 p-3 align-items-center'>
            ...
            <div class='col-md-2 mt-lg-0 mt-md-0 mt-4 text-center'>
              <h6 class='mb-4'>$room_data[price]VNĐ/một đêm</h6>
              $book_btn
    ...
    if($count_rooms>0){
      ...
      echo"<h3 class='text-center text-danger'>Xin lỗi hẹn tại chúng tôi đã hết phòng!</h3>";
    }
