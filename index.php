...
<body class="bg-light">
        ...
        <form action="rooms.php">
          <div class="row align-items-end">
            ...
            <div class="col-lg-1 mb-lg-3 mt-2">
              <button type="submit" class="btn text-white shadow-none custom-bg">Đăng ký</button>
            </div>
          </div>
        </form>
      </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-12 text-center mt-5">
        <a href="rooms.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">Thêm chi tiết về phòng>>></a>
      </div>
    </div>
  </div>
  ...
  <h2 class="mt-5 pt-4 mb-4 text-center fw-bold h-font">Cơ sở vật chất của chúng tôi</h2>
  ...
  <div class="container">
    <div class="row justify-content-evenly px-lg-0 px-md-0 px-5">
      ...
      <div class="col-lg-12 text-center mt-5">
        <a href="facilities.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">Tìm hiểu thêm về cơ sở vật chất>>></a>
      </div>
    </div>
  </div>
        ...
        <form id="recovery-form">
          ...
          <div class="modal-body">
            ...
            <div class="mb-2 text-end">
              <button type="button" class="btn shadow-none me-2" data-bs-dismiss="modal">HỦY</button>
