  ...
  <div class="col-lg-9 col-md-12 px-4">
    <div class="card mb-4 border-0 shadow">
      <div class="row g-0 p-3 align-items-center">
        <div class="col-md-5 mb-lq-0 mb-md-0 mb-3">
          <img src="images/about/about.jpg" class="img-fluid rounded">
        </div>
    ...
    <span class="badge rounded-pill bg-light text-dark text-wrap">4 Children</span>
        ...
        <a href="#" class="btn btn-sm  w-100 text-white custom-bg" mb-2>Đặt ngay</a>
